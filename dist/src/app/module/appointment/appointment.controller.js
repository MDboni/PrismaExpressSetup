...
const bookAppointmentCallback = catchAsync(async (req, res) => {
...
const getMyAppointments = catchAsync(async (req, res) => {
    const user = req.user;
    const { data, meta } = await AppointmentServices.getMyAppointments(req.query, user);
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
...
const getDoctorAppointments = catchAsync(async (req, res) => {
    const user = req.user;
    const { data, meta } = await AppointmentServices.getDoctorAppointments(req.query, user);
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
        message: "Appointments Retrieved Successfully",
