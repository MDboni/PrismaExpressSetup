...
// @ts-nocheck 
/*
 * This file exports the `Apppointment` model and its related types.
 *
...
export type GetApppointmentAggregateType<T extends ApppointmentAggregateArgs> = {
      [P in keyof T & keyof AggregateApppointment]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateApppointment[P]>
    : Prisma.GetScalarType<T[P], AggregateApppointment[P]>
}
...
export type GetApppointmentGroupByPayload<T extends ApppointmentGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ApppointmentGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ApppointmentGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ApppointmentGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ApppointmentGroupByOutputType[P]>
      }
    >
  >
...
export type ApppointmentCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ApppointmentFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ApppointmentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['Apppointment'], meta: { name: 'Apppointment' } }
  /**
   ...
   * })
  **/
  count<T extends ApppointmentCountArgs>(
    args?: Prisma.Subset<T, ApppointmentCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ApppointmentCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ApppointmentGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ApppointmentGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetApppointmentGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
