...
const applyAsDoctor = catchAsync(async (req, res) => {
    ...
    if (!zodValidationResult.success) {
        throw new AppError(httpStatus.BAD_REQUEST, zodValidationResult.error.issues[0]?.message ?? "Invalid input data");
    }
...
const getAvailableDoctorByTodaysSchedule = catchAsync(async (req, res) => {
...
const getAllDoctorsListPublic = catchAsync(async (req, res) => {
...
const getSingleDoctorPublicProfile = catchAsync(async (req, res) => {
